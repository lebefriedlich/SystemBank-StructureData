...
public class masuk extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/masuk.png"))); // NOI18N
    ...
    private void btn_loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_loginActionPerformed
        if (tf_username.getText().trim().equals("")) {
        ...
        } else if (tf_username.getText().trim().equals("admin") && pf_password.getText().trim().equals("admin")) {
            Session.setStatusLogin("AKTIF");
            dispose();
            menu_admin ma = new menu_admin();
            ma.setVisible(true);
        } else {
            pesan = sc.checkLogin(tf_username.getText(), pf_password.getText());
