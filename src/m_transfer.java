...
public class m_transfer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icon/saldo.png"))); // NOI18N
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/m_transfer.png"))); // NOI18N
    ...
    private void jLabel8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel8MouseClicked
        if (tf_rekTuj.getText().trim().equals("")) {
            ...
            tf_nom.requestFocus();
        } else if (tf_rekTuj.getText().trim().equals(Session.getNo_rek())) {
            JOptionPane.showMessageDialog(null, "Maaf Tidak Bisa Transfer ke Rekening Sendiri");
            tf_rekTuj.requestFocus();
        } else {
            try {
                String nom = tf_nom.getText().replace(".", "");
                sc.minusSaldo(Session.getNo_rek(), nom, "Transfer Keluar", ("ke " + tf_rekTuj.getText()));
                sc.plusSaldo(tf_rekTuj.getText(), nom, "Transfer Masuk", "dari " + Session.getNo_rek());
                JOptionPane.showMessageDialog(null, "Anda berhasil transfer", "Informasi", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void tf_rekTujActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tf_rekTujActionPerformed
        if (tf_rekTuj.getText().trim().equals(Session.getNo_rek())) {
            JOptionPane.showMessageDialog(null, "Maaf Tidak Bisa Transfer ke Rekening Sendiri");
            tf_rekTuj.requestFocus();
