...
public class daftar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icon/username.png"))); // NOI18N

        jLabel4.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel4.setText("Password");

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icon/password.png"))); // NOI18N
        ...
        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icon/noTelp.png"))); // NOI18N

        jLabel12.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel12.setText("Email");

        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icon/email.png"))); // NOI18N
        ...
        jLabel15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icon/saldo.png"))); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/daftar.png"))); // NOI18N
    ...
    private void tf_saldoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tf_saldoKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (tf_namaLengkap.getText().trim().equals("")) {
                ...
                tf_username.requestFocus();
            } else if (pf_password.getText().trim().equals("")) {
                ...
                pesan = sc.cekData(tf_username.getText());
                if (pesan != null) {
                    JOptionPane.showMessageDialog(null, "Maaf, Username sudah terdaftar");
                    tf_username.requestFocus();
                } else {  
                    String saldo = tf_saldo.getText().replace(".", "");
                    sc.registrasiNasabah(tf_namaLengkap.getText(), tf_username.getText(), pf_password.getText(), tf_noTelp.getText(),
    ...
    private void btn_signUpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_signUpActionPerformed
        if (tf_namaLengkap.getText().trim().equals("")) {
            ...
            sc.cekData(tf_username.getText());
                if (pesan != null) {
                    JOptionPane.showMessageDialog(null, "Maaf, Username sudah terdaftar");
                    tf_username.requestFocus();
                } else {  
